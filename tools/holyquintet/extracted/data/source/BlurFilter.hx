...
class BlurFilter
{
	 ...
	 */
	public var blurShader_reduce:FunkinShader = new FunkinShader("
		#pragma header
	 ...
	 */
	public var blurShader_blur_1:FunkinShader = new FunkinShader("
		#pragma header
	 ...
	 */
	public var blurShader_blur_2:FunkinShader = new FunkinShader("
		#pragma header
	 ...
	 */
	public var blurShader_amplification:FunkinShader = new FunkinShader("
		#pragma header
	...
	public function setModifier(value:Float)
	{
		...
		reduce.modifier = modifierTable[index];
	}
}
