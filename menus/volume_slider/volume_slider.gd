...
func _refresh_bars() -> void:
	var steps: float = _db_to_steps(AudioServer.get_bus_volume_db(AudioServer.get_bus_index("Master")))
	var lit_bars: int = roundi(steps / MAX_STEPS * bar_container.get_child_count())
